...
:: settings to create mzp file in current directory
SET dir=%~dp0
SET Configuration=Release
SET targetDir=%dir%mzp\
SET output=%dir%moshimoshisekai.mzp

:: 7zip needs to be installed for mzp files
...
::Copy dll from dotnet to maxscript
::ECHO.
::ECHO Copying dll to bundle...
...
::error message for unable to find dll
:OutlinerDllError
